...
class TestMCPServer:
    ...
    def mcp_server(self):
        ...
        with patch("youtrack_mcp.tools.issues.IssueTools") as mock_issue_tools, patch(
            "youtrack_mcp.tools.projects.ProjectTools"
        ) as mock_project_tools, patch(
            "youtrack_mcp.tools.users.UserTools"
        ) as mock_user_tools, patch(
            "youtrack_mcp.tools.search.SearchTools"
        ) as mock_search_tools, patch(
            "youtrack_mcp.tools.resources.ResourcesTools"
        ) as mock_resources_tools:
    ...
    def test_register_tools_with_tool_definitions(self, mcp_server):
        ...
        project_definitions = {
            "get_projects": {"description": "Get all projects", "function": Mock()}
        }
...
class TestMCPServerArchitecture:
    ...
    def test_mcp_server_is_incomplete_base_class(self):
        ...
        with patch("youtrack_mcp.tools.issues.IssueTools"), patch(
            "youtrack_mcp.tools.projects.ProjectTools"
        ), patch("youtrack_mcp.tools.users.UserTools"), patch(
            "youtrack_mcp.tools.search.SearchTools"
        ), patch(
            "youtrack_mcp.tools.resources.ResourcesTools"
        ):
