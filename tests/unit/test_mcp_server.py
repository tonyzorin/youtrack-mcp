...
class TestMCPServer:
    ...
    @pytest.mark.unit
    def test_get_all_tool_definitions_with_mocked_tools(self, mock_youtrack_client):
        ...
        with patch.object(mcp_server.issue_tools, 'get_tool_definitions', return_value=mock_issue_definitions), \
             patch.object(mcp_server.project_tools, 'get_tool_definitions', return_value=mock_project_definitions), \
             patch.object(mcp_server.user_tools, 'get_tool_definitions', return_value={}), \
             patch.object(mcp_server.search_tools, 'get_tool_definitions', return_value={}), \
             patch.object(mcp_server.resources_tools, 'get_tool_definitions', return_value={}):
    ...
    @pytest.mark.unit
    def test_conflict_resolution_with_resource_tools(self, mock_youtrack_client):
        ...
        with patch.object(mcp_server.issue_tools, 'get_tool_definitions', return_value=mock_issue_definitions), \
             patch.object(mcp_server.project_tools, 'get_tool_definitions', return_value={}), \
             patch.object(mcp_server.user_tools, 'get_tool_definitions', return_value={}), \
             patch.object(mcp_server.search_tools, 'get_tool_definitions', return_value={}), \
             patch.object(mcp_server.resources_tools, 'get_tool_definitions', return_value=mock_resource_definitions):
            ...
            assert all_tools["resource_get_issue"]["description"] == "Get issue as resource"
    ...
    def test_empty_tool_definitions_handled(self, mock_youtrack_client):
        ...
        with patch.object(mcp_server.issue_tools, 'get_tool_definitions', return_value={}), \
             patch.object(mcp_server.project_tools, 'get_tool_definitions', return_value={}), \
             patch.object(mcp_server.user_tools, 'get_tool_definitions', return_value={}), \
             patch.object(mcp_server.search_tools, 'get_tool_definitions', return_value={}), \
             patch.object(mcp_server.resources_tools, 'get_tool_definitions', return_value={}):
...
class TestMCPServerIntegration:
    ...
    def test_real_tool_definitions_structure(self, mock_youtrack_client):
        ...
        for tool_name, tool_config in all_tools.items():
            assert "description" in tool_config, f"Tool {tool_name} missing description"
            assert "function" in tool_config, f"Tool {tool_name} missing function"
            assert "parameter_descriptions" in tool_config, f"Tool {tool_name} missing parameter_descriptions"
