...
class TestToolPrioritization:
    ...
    def test_loader_with_tool_definitions(self, mock_youtrack_client):
        ...
        with patch('youtrack_mcp.tools.issues.IssueTools', return_value=mock_with_tools):
    ...
    def test_multiple_tool_definitions(self, mock_youtrack_client):
        ...
        with patch('youtrack_mcp.tools.issues.IssueTools', return_value=issues_mock):
            with patch('youtrack_mcp.tools.projects.ProjectTools', return_value=projects_mock):
                with patch('youtrack_mcp.tools.users.UserTools', return_value=empty_mock):
                    with patch('youtrack_mcp.tools.search.SearchTools', return_value=empty_mock):
                        with patch('youtrack_mcp.tools.resources.ResourcesTools', return_value=empty_mock):
                            tools = load_all_tools()
