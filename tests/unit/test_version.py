...
class TestVersion:
    ...
    def test_version_format(self):
        ...
        assert re.match(semver_pattern, version_str), f"Version {version_str} doesn't follow semantic versioning"
    ...
    def test_version_components(self):
        ...
        for i in range(3):
            assert version_parts[i].isdigit(), f"Version component {i} should be numeric"
