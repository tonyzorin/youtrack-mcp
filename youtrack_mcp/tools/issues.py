"""
YouTrack Issue Management Tools - Modular Interface.

This module provides a unified interface to the modular issue management system.
All functions have been refactored into separate modules for better maintainability.

Modules:
- dedicated_updates: State, priority, assignee, type, and estimation updates
- diagnostics: Workflow analysis and help system
- custom_fields: Custom field management and validation
- basic_operations: Core CRUD operations (get, search, create, update, comment)
- linking: Issue relationships and dependencies
- attachments: File handling and raw data access
- utilities: Infrastructure and tool definitions

This file serves as a backward-compatible interface while the codebase transitions
...
from .issues.dedicated_updates import DedicatedUpdates
from .issues.diagnostics import Diagnostics
from .issues.custom_fields import CustomFields
from .issues.basic_operations import BasicOperations
from .issues.linking import Linking
from .issues.attachments import Attachments
from .issues.utilities import Utilities
...
class IssueTools:
    ...
    def __init__(self, issues_api, projects_api):
        ...
        self.dedicated_updates = DedicatedUpdates(issues_api, projects_api)
        self.diagnostics = Diagnostics(issues_api, projects_api)
        self.custom_fields = CustomFields(issues_api, projects_api)
        self.basic_operations = BasicOperations(issues_api, projects_api)
        self.linking = Linking(issues_api, projects_api)
        self.attachments = Attachments(issues_api, projects_api)
        self.utilities = Utilities(issues_api, projects_api)
